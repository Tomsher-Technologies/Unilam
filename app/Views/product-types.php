                            ...
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <a href="create-product-type"> <button type="button" class="btn btn-secondary waves-effect waves-light">Create</button></a>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table mb-0">
                                            ...
                                            <?php if (isset($productTypeDetails) && !empty($productTypeDetails)) : ?>
                                                <tbody>
                                                    <?php $rowNumber = 1; ?>
                                                    <?php foreach ($productTypeDetails as $productTypeDetails_row) { ?>
                                                        <tr>
                                                            <th scope="row"><?= $rowNumber++; ?></th>
                                                            <td> <?= $productTypeDetails_row['typeTitle']; ?></td>
                                                            <td>
                                                                <?= DateTime::createFromFormat('Y-m-d H:i:s', $productTypeDetails_row['createdOn'])->format('Y-m-d'); ?>
                                                            </td>
                                                            <td>
                                                                <div class="tools">
                                                                    <a href="edit-product-type/<?= $productTypeDetails_row['canonicalName']; ?>">
                                                                        <i class="mdi mdi-pencil"></i>
                                                                    </a>
                                                                    <a class="deleteButton" href="delete-product-type/<?= $productTypeDetails_row['productTypeID']; ?>">
