                                    ...
                                    <table class="table mb-0">
                                        ...
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>Content Type</th>
                                                <th>Content Title 1</th>
                                                <th>Content Sub Title 1</th>
                                                <th>Content Title Mode 1</th>
                                                <th>Tools</th>
                                            </tr>
                                        </thead>
                                        <?php if (isset($contentsDetails) && !empty($contentsDetails)) : ?>
                                            <tbody>
                                                <?php $rowNumber = 1; ?>
                                                <?php foreach ($contentsDetails as $contentsDetails_row) { ?>
                                                    <tr>
                                                        <th scope="row"><?= $rowNumber++; ?></th>
                                                        <td> <?= $contentsDetails_row['contentType']; ?></td>
                                                        <td> <?= $contentsDetails_row['contentTitle1']; ?></td>
                                                        <td> <?= $contentsDetails_row['contentSubTitle1']; ?></td>
                                                        <td> <?= $contentsDetails_row['contentTitleMode1']; ?></td>
                                                        <td>
                                                            <div class="tools">
                                                                <a href="edit-contents/<?= $contentsDetails_row['contentID']; ?>">
