                            ...
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <a href="create-service"> <button type="button" class="btn btn-secondary waves-effect waves-light">Create</button></a>
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php foreach ($serviceDetails as $serviceDetails_row) { ?>
                                                        <tr>
                                                            ...
                                                            <td> <?= $serviceDetails_row['serviceTitle']; ?></td>
                                                            <td> <?= $serviceDetails_row['serviceHeadLine']; ?></td>
                                                            <td>
                                                                <?= DateTime::createFromFormat('Y-m-d H:i:s', $serviceDetails_row['createdOn'])->format('Y-m-d'); ?>
                                                            </td>
                                                            <td>
                                                                <div class="tools">
