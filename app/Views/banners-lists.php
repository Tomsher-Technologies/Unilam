                            ...
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <a href="create-banner"> <button type="button" class="btn btn-secondary waves-effect waves-light">Create</button></a>
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php foreach ($bannerDetails as $bannerDetails_row) { ?>
                                                        <tr>
                                                            ...
                                                            <td> <?= $bannerDetails_row['bannerHeading']; ?></td>
                                                            <td> <?= $bannerDetails_row['bannerTitle']; ?></td>
                                                            <td>
                                                                <?= DateTime::createFromFormat('Y-m-d H:i:s', $bannerDetails_row['createdOn'])->format('Y-m-d'); ?>
                                                            </td>
                                                            <td>
                                                                <div class="tools">
