                                ...
                                <div class="octf-col menu-col no-padding">
                                    <nav id="site-navigation" class="main-navigation">
                                        <ul class="menu">
                                                                    ...
                                                                    <li>
                                                                        <div class="nav-category-item d-flex">
                                                                            <div class="thumbnail">
                                                                                ...
                                                                                <a href="<?= base_url('products') ?>/<?= $navProducts_row->canonicalName ?>">
                                                ...
                                                <ul class="sub-menu">
                                                    <?php if (isset($navService) && !empty($navService)) : ?>
                                                        <?php foreach ($navService as $navService_row) :  ?>
                                                            <li><a href="<?= base_url('services') ?>/<?= $navService_row->canonicalName ?>"> <?= $navService_row->serviceTitle ?></a></li>
                                                        <?php endforeach ?>
                                                    <?php endif; ?>
                                                </ul>
                                            </li>
                                            ...
                                            <li><a href="https://tomsher.co/UNL/e-catalogue.pdf" target="_blank">Catalogue</a></li>
                                        </ul>
                                    </nav>
                                </div>
                                    ...
                                    <div class="mmenu-inner">
                                        ...
                                        <div class="mobile-nav">
                                            <ul id="menu-main-menu" class="mobile_mainmenu none-style">
                                                ...
                                                <li><a href="<?= base_url('works') ?>">OUR WORKS</a></li>
                                                <li><a href="<?= base_url('contact') ?>">CONTACT US</a></li>
                                                <li><a href="https://tomsher.co/UNL/e-catalogue.pdf">CATALOGUE</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
