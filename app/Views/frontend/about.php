  ...
  <div id="content" class="site-content">
      <div class="page-header dtable text-center header-transparent pheader-studio" style="background-image: url(<?= base_url($aboutPageDetails['bannerImageUrl']) ?>);">
          <div class="dcell">
              <div class="container">
          ...
          <div class="container">
              <div class="row">
                  ...
                  <div class="col-xl-4 col-lg-12 col-md-12 pl-xl-7">
                      <div class="our-studio-detail" style="    background-image: url(public/mainassets/images/about-bg-22.jpg);
