        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="/" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="<?= base_url('public/assets/images/logo.svg') ?>" alt="" height="45">
                    </span>
                    <span class="logo-lg">
                        <img src="<?= base_url('public/assets/images/logo.svg') ?>" alt="" height="45">
                        <!-- <span class="logo-txt">Unilam</span> -->
                    </span>
                </a>
        ...
        <div class="d-flex">
                        ...
                        <a href="#!" class="text-reset notification-item">
                            <div class="d-flex">
                                <div class="flex-shrink-0 me-3">
                                    <img src="../public/assets/images/avatar-3.jpg" class="rounded-circle avatar-sm" alt="user-pic">
                                </div>
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item bg-soft-light border-start border-end" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user" src="<?= base_url('public/assets/images/admin.png') ?> " alt="Header Avatar">
                    <span class="d-none d-xl-inline-block ms-1 fw-medium">Admin</span>
                    <i class="mdi mdi-chevron-down d-none d-xl-inline-block"></i>
                </button>
                <div class="dropdown-menu dropdown-menu-end">
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="<?= base_url('admin/login') ?>"><i class="mdi mdi-logout font-size-16 align-middle me-1"></i> <?= lang('Files.Logout') ?></a>
                </div>
            </div>
