                            ...
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <a href="create-work-category"> <button type="button" class="btn btn-secondary waves-effect waves-light">Create</button></a>
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                ...
                                <div class="card-header">
                                    <h4 class="card-title">Work category lists</h4>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table mb-0">
                                            ...
                                            <?php if (isset($workcategoryDetails) && !empty($workcategoryDetails)) : ?>
                                                <tbody>
                                                    <?php $rowNumber = 1; ?>
                                                    <?php foreach ($workcategoryDetails as $workcategoryDetails_row) { ?>
                                                        <tr>
                                                            <th scope="row"><?= $rowNumber++; ?></th>
                                                            <td> <?= $workcategoryDetails_row['categoryName']; ?></td>
                                                            <td>
                                                                <?= DateTime::createFromFormat('Y-m-d H:i:s', $workcategoryDetails_row['createdOn'])->format('Y-m-d'); ?>
                                                            </td>
                                                            <td>
                                                                <div class="tools">
