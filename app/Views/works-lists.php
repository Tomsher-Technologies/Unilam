                            ...
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <a href="create-work"> <button type="button" class="btn btn-secondary waves-effect waves-light">Create</button></a>
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php foreach ($worksDetails as $worksDetails_row) { ?>
                                                        <tr>
                                                            ...
                                                            <td> <?= $worksDetails_row['projectTitle']; ?></td>
                                                            <td> <?= $worksDetails_row['projectLocation']; ?></td>
                                                            <td> <?= $worksDetails_row['projectType']; ?></td>
                                                            <td> <?= $worksDetails_row['services']; ?></td>
                                                            <td>
                                                                <?= DateTime::createFromFormat('Y-m-d', $worksDetails_row['projectDate'])->format('Y-m-d'); ?>
                                                            </td>
                                                            <td>
                                                                <div class="tools">
                                                                    <a href="edit-work/<?= $worksDetails_row['canonicalName']; ?>">
                                                                        <i class="mdi mdi-pencil"></i>
                                                                    </a>
                                                                    <a class="deleteButton" href="delete-work/<?= $worksDetails_row['workID']; ?>">
