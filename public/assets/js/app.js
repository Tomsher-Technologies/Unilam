/*
Template Name: Unilam - Bootstrap 5 Admin & Dashboard Template
Author: Themesbrand
Version: 1.1.0
...
(function ($) {
    ...
    var language = localStorage.getItem('Unilam-language');
    // Default Language
    var default_lang = 'en';
    ...
    function setLanguage(lang) {
        if (document.getElementById("header-lang-img")) {
            if (lang == 'en') {
                document.getElementById("header-lang-img").src = "public/assets/images/flags/us.jpg";
            } else if (lang == 'sp') {
                document.getElementById("header-lang-img").src = "public/assets/images/flags/spain.jpg";
            } else if (lang == 'gr') {
                document.getElementById("header-lang-img").src = "public/assets/images/flags/germany.jpg";
            } else if (lang == 'it') {
                document.getElementById("header-lang-img").src = "public/assets/images/flags/italy.jpg";
            } else if (lang == 'ru') {
                document.getElementById("header-lang-img").src = "public/assets/images/flags/russia.jpg";
            }
            localStorage.setItem('Unilam-language', lang);
            language = localStorage.getItem('Unilam-language');
            getLanguage();
        }
    }
    ...
    function getLanguage() {
        ...
        $.getJSON('public/assets/lang/' + language + '.json', function (lang) {
