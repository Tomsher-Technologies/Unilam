( function( $ ) {
    ...
    $('.unilam-menu-form-coupon-toggle .showcoupon').on("click", function(){
        $(this).toggleClass( "active" );
        if ($(this).hasClass( "active" )) {
            $('.unilam-menu-form-coupon').stop(true, true).slideDown();
        }else{
            $('.unilam-menu-form-coupon').stop(true, true).slideUp();
        }
    });
    /* --------------------------------------------------
    * sticky header
